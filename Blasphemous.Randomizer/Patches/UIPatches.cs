...
public class UIControllerArea_Patch
{
    ...
    {
        return Main.Randomizer.CurrentSettings.DoorShuffleType <= 1;
    }
}
...
public class CutscenePlay_Patch
{
    ...
    {
        if (__instance.cutscene != null && Main.Randomizer.DataHandler.CutsceneNames.Contains(__instance.cutscene.name))
        {
...
public class MapZoneItems_Patch
{
    ...
    {
        Main.Randomizer.ZoneHandler.UpdateMap(__instance, ___CurrentCell);
    }
}
