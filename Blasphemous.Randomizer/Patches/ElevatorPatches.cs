...
public class EventManagerSave_Patch
{
    ...
    {
        if (Main.Randomizer.CurrentSettings.DoorShuffleType <= 0) return;
        ...
        Door doorToEnter = Main.Randomizer.itemShuffler.LastDoor;
...
public class PlatformLoad_Patch
{
    ...
    {
        return Main.Randomizer.CurrentSettings.DoorShuffleType <= 0 || Core.LevelManager.currentLevel.LevelName != "D02Z02S11" || __instance.GetPersistenID() != "e78fa0c2-ba1f-40f4-97cc-394162f84d7c";
    }
}
