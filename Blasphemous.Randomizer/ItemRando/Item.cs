...
namespace Blasphemous.Randomizer.ItemRando
{
    public class Item
    {
        ...
        /// <summary>
        /// The display notification of the item
        /// </summary>
        public virtual string GetNotification(bool upgraded)
        {
            return Main.Randomizer.LocalizationHandler.Localize(type switch
            {
                0 => "bead",
                1 => "prayer",
                2 => "relic",
