...
namespace BlasphemousRandomizer
{
	public class DataStorage
	{
		...
		private List<ItemLocation> fillLocations()
		{
			...
			locations.Add(new ItemLocation("RESCUED_CHERUB_06", "CH", "cherub", (InventoryData d) => d.cherubAttack(0x42) || (d.root && d.cherubAttack(0x30400)) || (d.blood && (d.linen || d.root))));
			...
			locations.Add(new ItemLocation("RESCUED_CHERUB_13", "CH", "cherub", (InventoryData d) => d.linen || d.nail || d.cherubAttack(0x72242)));
			...
			locations.Add(new ItemLocation("RESCUED_CHERUB_20", "CH", "cherub", (InventoryData d) => d.root || d.cherubAttack(0x32272)));
			locations.Add(new ItemLocation("RESCUED_CHERUB_21", "CH", "cherub", (InventoryData d) => d.blood && (d.cherubAttack(0x2000) && d.ranged || d.cherubAttack(0x30642))));
			locations.Add(new ItemLocation("RESCUED_CHERUB_22", "CH", "cherub", (InventoryData d) => d.linen || (d.lung && d.nail && d.cherubAttack(0x20042))));
			locations.Add(new ItemLocation("RESCUED_CHERUB_23", "CH", "cherub", (InventoryData d) => d.root || d.cherubAttack(0x20042)));
			locations.Add(new ItemLocation("RESCUED_CHERUB_24", "CH", "cherub", (InventoryData d) => d.linen || d.cherubAttack(0x30242)));
			locations.Add(new ItemLocation("RESCUED_CHERUB_25", "CH", "cherub", (InventoryData d) => d.blood || d.cherubAttack(0x26652)));
			locations.Add(new ItemLocation("RESCUED_CHERUB_26", "CH", "cherub", (InventoryData d) => true));
			locations.Add(new ItemLocation("RESCUED_CHERUB_27", "CH", "cherub", (InventoryData d) => (d.fullThimble || d.linen) && d.cherubAttack(0x66252)));
			...
			locations.Add(new ItemLocation("RESCUED_CHERUB_31", "CH", "cherub", (InventoryData d) => d.blood || d.cherubAttack(0x20042)));
			locations.Add(new ItemLocation("RESCUED_CHERUB_32", "CH", "cherub", (InventoryData d) => d.bridgeAccess && d.blood && d.canBeatBoss("exposito") && ((d.dawnHeart && d.ranged && d.cherubAttack(0x20042)) || d.root)));
			locations.Add(new ItemLocation("RESCUED_CHERUB_33", "CH", "cherub", (InventoryData d) => d.bridgeAccess && d.cherubAttack(0x30242)));
			...
			locations.Add(new ItemLocation("RESCUED_CHERUB_38", "CH", "cherub", (InventoryData d) => d.cherubAttack(0x66210) || d.wheel || d.dawnHeart));
