...
namespace Framework.Randomizer
{
	internal class ForwardFiller
	{
		public bool Fill(int seed, Dictionary<string, Reward> output)
		{
			...
			string spoiler = new Spoiler().createSpoiler(output);
			stopwatch.Stop();
			string text = string.Format("Filling seed {0}\nExecution time: {1} ms\n\n", seed, stopwatch.ElapsedMilliseconds);
			string path = "spoiler" + PersistentManager.GetAutomaticSlot() + ".txt";
			new FileIO().write(text + spoiler, path);
			return true;
		}

		public ForwardFiller(List<string> randoSettings)
		{
		...
		private void getLists(List<Location> locations, List<Reward> rewards)
		{
			...
			locations.Add(new Location("PR101", "amanecida2", (ItemData d) => true));
			...
			locations.Add(new Location("RE03", "redento2", (ItemData d) => d.bridge && d.limestones >= 3));
			...
			locations.Add(new Location("HE101", "amanecida2", (ItemData d) => true));
			...
			locations.Add(new Location("CO04", "item", (ItemData d) => true));
			...
			locations.Add(new Location("CO42", "item", (ItemData d) => d.blood));
			...
			locations.Add(new Location("QI50", "item", (ItemData d) => d.bridge));
			...
			locations.Add(new Location("QI56", "tirso", (ItemData d) => d.herbs >= 6 && d.bridge && d.masks > 0 && d.bronzeKey && d.silverKey));
			...
			locations.Add(new Location("QI101", "item", (ItemData d) => true));
			...
			locations.Add(new Location("QI107", "amanecida2", (ItemData d) => true));
			locations.Add(new Location("QI108", "amanecida2", (ItemData d) => true));
			locations.Add(new Location("QI109", "amanecida2", (ItemData d) => true));
			locations.Add(new Location("QI110", "amanecida2", (ItemData d) => true));
			...
			locations.Add(new Location("RESCUED_CHERUB_27", "cherub", (ItemData d) => d.fullThimble || d.linen));
			...
			locations.Add(new Location("RESCUED_CHERUB_38", "cherub", (ItemData d) => true));
			...
			locations.Add(new Location("250.Undertaker", "ossuary", (ItemData d) => d.bones >= 44));
			locations.Add(new Location("500.Undertaker", "ossuary", (ItemData d) => d.bones >= 44));
			locations.Add(new Location("750.Undertaker", "ossuary", (ItemData d) => d.bones >= 44));
			locations.Add(new Location("1000.Undertaker", "ossuary", (ItemData d) => d.bones >= 44));
			locations.Add(new Location("1250.Undertaker", "ossuary", (ItemData d) => d.bones >= 44));
			locations.Add(new Location("1500.Undertaker", "ossuary", (ItemData d) => d.bones >= 44));
			locations.Add(new Location("1750.Undertaker", "ossuary", (ItemData d) => d.bones >= 44));
			locations.Add(new Location("2000.Undertaker", "ossuary", (ItemData d) => d.bones >= 44));
			locations.Add(new Location("2500.Undertaker", "ossuary", (ItemData d) => d.bones >= 44));
			locations.Add(new Location("3000.Undertaker", "ossuary", (ItemData d) => d.bones >= 44));
			...
			locations.Add(new Location("BS12", "boss", (ItemData d) => d.bridge));
			...
			for (int m = 0; m < 7; m++)
			{
				rewards.Add(new Reward(9, 0, false));
			}
			rewards.Add(new Reward(10, 500));
			rewards.Add(new Reward(10, 1000));
			rewards.Add(new Reward(10, 2000));
			rewards.Add(new Reward(10, 5000));
			rewards.Add(new Reward(10, 10000));
			rewards.Add(new Reward(10, 500));
			rewards.Add(new Reward(10, 1000));
			rewards.Add(new Reward(10, 1000));
			rewards.Add(new Reward(10, 3000));
			rewards.Add(new Reward(10, 5000));
			rewards.Add(new Reward(10, 250));
			rewards.Add(new Reward(10, 500));
			rewards.Add(new Reward(10, 750));
			rewards.Add(new Reward(10, 1000));
			rewards.Add(new Reward(10, 1250));
			rewards.Add(new Reward(10, 1500));
			rewards.Add(new Reward(10, 1750));
			rewards.Add(new Reward(10, 2000));
			rewards.Add(new Reward(10, 2500));
			rewards.Add(new Reward(10, 3000));
			rewards.Add(new Reward(10, 5000));
			bool hardMode = Core.Randomizer.gameConfig.hardMode;
			rewards.Add(new Reward(10, hardMode ? 750 : 625));
			rewards.Add(new Reward(10, hardMode ? 3120 : 2600));
			rewards.Add(new Reward(10, hardMode ? 2520 : 2100));
			rewards.Add(new Reward(10, hardMode ? 6600 : 5500));
			rewards.Add(new Reward(10, hardMode ? 10800 : 9000));
			rewards.Add(new Reward(10, hardMode ? 5160 : 4300));
			rewards.Add(new Reward(10, hardMode ? 360 : 300));
			rewards.Add(new Reward(10, hardMode ? 13500 : 11250));
			rewards.Add(new Reward(10, hardMode ? 21600 : 18000));
		}
