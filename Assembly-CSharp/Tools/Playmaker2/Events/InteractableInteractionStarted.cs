...
namespace Tools.Playmaker2.Events
{
	...
	public class InteractableInteractionStarted : FsmStateAction
	{
		public override void OnEnter()
		{
			if (this.listenOnlySelf.Value)
			{
				Interactable.SInteractionStarted += this.ListenToSelf;
			}
			else
			{
				Interactable.SInteractionStarted += this.ListenToAll;
			}
		}
